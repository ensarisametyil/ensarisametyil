...
namespace CvAnalyzer.Api.Data.Migrations
{
    ...
    [Migration("20260902201001_AddCareerAssistantResults")]
    partial class AddCareerAssistantResults
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CvAnalyzer.Api.Models.Entities.AdminAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CvAnalyzer.Api.Models.Entities.CareerAssistantResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "CvId", "Type", "CreatedAt");

                    b.ToTable("CareerAssistantResults");
                });
            ...
            modelBuilder.Entity("CvAnalyzer.Api.Models.Entities.AdminAuditLog", b =>
                {
                    b.HasOne("CvAnalyzer.Api.Models.Entities.User", "AdminUser")
                        .WithMany()
